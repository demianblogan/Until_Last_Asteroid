...
namespace
{
	...
	{
		CreditLine{ "credits.line_1", 34u, UI::MenuTheme::SelectionGlow, 250.f },
		CreditLine{ "credits.line_2", 28u, sf::Color(215, 238, 244), 310.f },
		CreditLine{ "credits.line_3", 27u, sf::Color(215, 238, 244), 360.f },
		CreditLine{ "credits.line_4", 27u, sf::Color(215, 238, 244), 406.f },
		CreditLine{ "credits.line_5", 27u, sf::Color(215, 238, 244), 450.f },
		CreditLine{ "credits.line_6", 29u, sf::Color(235, 246, 249), 506.f },
		CreditLine{ "credits.contact", 25u, sf::Color(150, 215, 230), 582.f },
		CreditLine{ "credits.email", 28u, UI::MenuTheme::InterfaceGlow, 622.f },
		CreditLine{ "credits.youtube", 25u, sf::Color(150, 215, 230), 680.f },
		CreditLine{ "credits.source", 24u, sf::Color(150, 215, 230), 738.f },
...
CreditsState::CreditsState(StateStack& stack, StateContext context)
	...
	, title(context.assets.Fonts().Get(context.localization.GetBoldFont()),
		context.localization.GetText("credits.title"), 72u)
...
void CreditsState::OnRender()
{
	...
	for (const sf::Text& line : bodyLines)
		window.draw(line);
