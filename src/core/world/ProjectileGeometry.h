...
{
	[[nodiscard]] std::optional<sf::Vector2f> TryCircleImpactDirection(
		sf::Vector2f center, float radius,
		sf::Vector2f projectilePosition, float projectileRadius);

	[[nodiscard]] std::optional<sf::Vector2f> TryAnnulusImpactDirection(
		sf::Vector2f center, float innerRadius, float outerRadius,
		sf::Vector2f projectilePosition, float projectileRadius);

	[[nodiscard]] std::optional<sf::Vector2f> TryDiamondFrameImpactDirection(
	...
	[[nodiscard]] std::optional<sf::Vector2f> TrySegmentImpactPoint(
