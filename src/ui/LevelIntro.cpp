...
namespace UI
{
	...
	void LevelIntro::ApplyAnimation()
	{
		...
		TextLayout::CenterText(levelLabel, { logicalSize.x * 0.5f, logicalSize.y * 0.5f - 22.f + rise });
		TextLayout::CenterText(title, { logicalSize.x * 0.5f, logicalSize.y * 0.5f + 53.f + rise });
